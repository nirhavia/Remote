...
public class TvClient {
    ...
    public static final int KEY_0=7,KEY_1=8,KEY_2=9,KEY_3=10,KEY_4=11,KEY_5=12,
        KEY_6=13,KEY_7=14,KEY_8=15,KEY_9=16,KEY_UP=19,KEY_DOWN=20,KEY_LEFT=21,
        KEY_RIGHT=22,KEY_OK=23,KEY_BACK=4,KEY_HOME=3,KEY_MENU=82,KEY_POWER=26,
        KEY_VOL_UP=24,KEY_VOL_DOWN=25,KEY_MUTE=164,KEY_CH_UP=166,KEY_CH_DOWN=167;
    ...
    private KeyManager[] loadCert(String ip) {
        try {
            ...
            ks.load(null,null);
            ks.setKeyEntry("k", pk, new char[0], new X509Certificate[0]);
    ...
    public void savePairing(String ip, byte[] keyBytes, byte[] certBytes) {
        ctx.getSharedPreferences(PREFS,0).edit()
            .putString("key_"+ip, android.util.Base64.encodeToString(keyBytes, android.util.Base64.DEFAULT))
